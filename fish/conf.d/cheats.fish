...
function cheats --description 'Show custom shell commands from this dotfiles setup'
    ...
    __cheats_row "tldv-dl <url>" "public tl;dv meeting → mp4 + srt/txt; --srt-only, -o dir"
    __cheats_row "bw-nihey" "Bitwarden CLI (default vault; URL set at install)"
    __cheats_row "bw-kassellabs" "Bitwarden CLI (Kassel Labs vault; URL set at install)"
